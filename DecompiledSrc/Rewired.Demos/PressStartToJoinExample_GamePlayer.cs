...
public class PressStartToJoinExample_GamePlayer : MonoBehaviour
{
	...
	private void ProcessInput()
	{
		...
		if (fire)
		{
			Object.Instantiate(bulletPrefab, base.transform.position + base.transform.right, base.transform.rotation).GetComponent<Rigidbody>().AddForce(base.transform.right * bulletSpeed, (ForceMode)2);
		}
	}
}
