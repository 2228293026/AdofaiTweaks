...
public class CustomButton : Button, ICustomSelectable, ICancelHandler, IEventSystemHandler
{
	...
	{
		if (!((Object)(object)base.animator == null) && ((Behaviour)(object)base.animator).enabled && ((Behaviour)(object)base.animator).isActiveAndEnabled && !((Object)(object)base.animator.runtimeAnimatorController == null) && !string.IsNullOrEmpty(triggername))
		{
