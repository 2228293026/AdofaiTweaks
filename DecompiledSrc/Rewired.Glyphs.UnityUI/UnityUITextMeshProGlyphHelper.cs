...
public class UnityUITextMeshProGlyphHelper : MonoBehaviour
{
	...
	private sealed class ControllerElementTag : Tag
	{
		...
		protected override void Clear()
		{
			...
			actionId = -1;
			actionId2 = -1;
			actionRange = (AxisRange)0;
			resultIndex = 0;
			action1FirstPole = (Pole)1;
		...
		public static bool TryParseString(string text, int startIndex, int count, StringBuilder sb1, StringBuilder sb2, Dictionary<string, string> workDictionary, Pool<ControllerElementTag> pool, out ControllerElementTag result)
		{
			...
			try
			{
				...
				{
					result.actionRange = (AxisRange)0;
				}
				...
				{
					result.action1FirstPole = (Pole)1;
				}
	...
	private sealed class RewiredElementHelper
	{
		...
		public bool TryGetActionElementMaps(int playerId, int actionId, int actionId2, AxisRange actionRange, int resultIndex, ControllerElementGlyphSelectorOptions options, RewiredElementResultSelectionHandler selectionHandler, RewiredElementResult2DSelectionHandler action2dSelectionHandler, out ActionElementMapPair action1Result, out ActionElementMapPair action2Result, int tagIndex)
		{
			...
			{
				result = ((!flag) ? TryGetActionElementMaps(playerId, actionId, (AxisRange)0, options, GetInternalIsAllowedHandler(), resultIndex, selectionHandler, tempAemPairs1, out action1Result, tagIndex) : TryGetActionElementMaps(playerId, actionId, actionId2, options, GetInternalIsAllowedHandler(), resultIndex, action2dSelectionHandler, temp2dResults, out action1Result, out action2Result, tagIndex));
			}
			else if (flag)
			{
	...
	private class TMProSprite_AssetV1_1_0 : ITMProSprite
	{
		...
		public class TMPro_SpriteGlyph
		{
			...
			public TMPro_SpriteGlyph()
			{
				...
				Initialize((Glyph)(object)_source);
			}
		...
		public uint id
		{
			get
			{
				return ((Glyph)_spriteGlyph.source).index;
			}
			set
			{
				((Glyph)_spriteGlyph.source).index = value;
		...
		public float width
		{
			get
			{
				...
				GlyphMetrics metrics = ((Glyph)_spriteGlyph.source).metrics;
				return ((GlyphMetrics)(ref metrics)).width;
			}
			set
			{
				//IL_000b: Unknown result type (might be due to invalid IL or missing references)
				...
				GlyphMetrics metrics = ((Glyph)_spriteGlyph.source).metrics;
				((GlyphMetrics)(ref metrics)).width = value;
				((Glyph)_spriteGlyph.source).metrics = metrics;
				GlyphRect glyphRect = ((Glyph)_spriteGlyph.source).glyphRect;
				((GlyphRect)(ref glyphRect)).width = (int)value;
				((Glyph)_spriteGlyph.source).glyphRect = glyphRect;
			}
		}
		...
		public float height
		{
			get
			{
				...
				//IL_0010: Unknown result type (might be due to invalid IL or missing references)
				GlyphMetrics metrics = ((Glyph)_spriteGlyph.source).metrics;
				return ((GlyphMetrics)(ref metrics)).height;
			}
			set
			{
				//IL_000b: Unknown result type (might be due to invalid IL or missing references)
				...
				//IL_004f: Unknown result type (might be due to invalid IL or missing references)
				GlyphMetrics metrics = ((Glyph)_spriteGlyph.source).metrics;
				((GlyphMetrics)(ref metrics)).height = value;
				((Glyph)_spriteGlyph.source).metrics = metrics;
				GlyphRect glyphRect = ((Glyph)_spriteGlyph.source).glyphRect;
				((GlyphRect)(ref glyphRect)).height = (int)value;
				((Glyph)_spriteGlyph.source).glyphRect = glyphRect;
			}
		}
		...
		public float xOffset
		{
			get
			{
				...
				//IL_0010: Unknown result type (might be due to invalid IL or missing references)
				GlyphMetrics metrics = ((Glyph)_spriteGlyph.source).metrics;
				return ((GlyphMetrics)(ref metrics)).horizontalBearingX;
			}
			set
			{
				//IL_000b: Unknown result type (might be due to invalid IL or missing references)
				...
				//IL_0024: Unknown result type (might be due to invalid IL or missing references)
				GlyphMetrics metrics = ((Glyph)_spriteGlyph.source).metrics;
				((GlyphMetrics)(ref metrics)).horizontalBearingX = value;
				((Glyph)_spriteGlyph.source).metrics = metrics;
			}
		}
		...
		public float yOffset
		{
			get
			{
				...
				//IL_0010: Unknown result type (might be due to invalid IL or missing references)
				GlyphMetrics metrics = ((Glyph)_spriteGlyph.source).metrics;
				return ((GlyphMetrics)(ref metrics)).horizontalBearingY;
			}
			set
			{
				//IL_000b: Unknown result type (might be due to invalid IL or missing references)
				...
				//IL_0024: Unknown result type (might be due to invalid IL or missing references)
				GlyphMetrics metrics = ((Glyph)_spriteGlyph.source).metrics;
				((GlyphMetrics)(ref metrics)).horizontalBearingY = value;
				((Glyph)_spriteGlyph.source).metrics = metrics;
			}
		}
		...
		public float xAdvance
		{
			...
			set
			{
				...
				//IL_0024: Unknown result type (might be due to invalid IL or missing references)
				GlyphMetrics metrics = ((Glyph)_spriteGlyph.source).metrics;
				((GlyphMetrics)(ref metrics)).horizontalAdvance = value;
				((Glyph)_spriteGlyph.source).metrics = metrics;
			}
		}
		...
		public Vector2 position
		{
			get
			{
				...
				//IL_0010: Unknown result type (might be due to invalid IL or missing references)
				GlyphRect glyphRect = ((Glyph)_spriteGlyph.source).glyphRect;
				return new Vector2(((GlyphRect)(ref glyphRect)).x, ((GlyphRect)(ref glyphRect)).y);
			}
			set
			{
				//IL_000b: Unknown result type (might be due to invalid IL or missing references)
				...
				GlyphRect glyphRect = ((Glyph)_spriteGlyph.source).glyphRect;
				((GlyphRect)(ref glyphRect)).x = (int)value.x;
				((GlyphRect)(ref glyphRect)).y = (int)value.y;
				((Glyph)_spriteGlyph.source).glyphRect = glyphRect;
			}
		}
		...
		public TMProSprite_AssetV1_1_0()
		{
			...
			_spriteCharacter.glyph = (Glyph)(object)_spriteGlyph.source;
		}
	...
	private static Dictionary<string, AxisRange> s_axisRangeTerms
	{
		get
		{
			if (__s_axisRangeTerms == null)
			{
				...
				dictionary.Add("f", (AxisRange)0);
				dictionary.Add("p", (AxisRange)1);
				dictionary.Add("pos", (AxisRange)1);
				dictionary.Add("+", (AxisRange)1);
				dictionary.Add("n", (AxisRange)2);
				dictionary.Add("neg", (AxisRange)2);
				dictionary.Add("-", (AxisRange)2);
	...
	private static Dictionary<string, Pole> s_poleTerms
	{
		get
		{
			if (__s_axisRangeTerms == null)
			{
				...
				dictionary.Add("p", (Pole)0);
				dictionary.Add("pos", (Pole)0);
				dictionary.Add("+", (Pole)0);
				dictionary.Add("n", (Pole)1);
				dictionary.Add("neg", (Pole)1);
				dictionary.Add("-", (Pole)1);
	...
	private bool TryGetControllerElementGlyphsOrText(ControllerElementTag tag, int tagIndex, List<GlyphOrText> results)
	{
		...
		if (tag.actionId >= 0 && tag.actionId2 >= 0 && tag.actionId != tag.actionId2 && (action1Result.Count > 0 || action2Result.Count > 0))
		{
			...
			string glyphKey = default(string);
			if (IsGlyphAllowed(tag.type) && ActionElementMap.TryGetCombinedElementIdentifierGlyph((IList<ActionElementMap>)_tempAems, ref obj) && ActionElementMap.TryGetCombinedElementIdentifierFinalGlyphKey((IList<ActionElementMap>)_tempAems, ref glyphKey))
			{
				item.glyphKey = glyphKey;
				item.sprite = obj as Sprite;
				results.Add(item);
				return true;
			}
			string text = default(string);
			if (IsTextAllowed(tag.type) && ActionElementMap.TryGetCombinedElementIdentifierName((IList<ActionElementMap>)_tempAems, ref text))
			{
				item.name = text;
				results.Add(item);
				return true;
		...
		{
			flag |= TryGetControllerElementGlyphsOrText(tag, action2Result, ((int)tag.action2FirstPole != -1) ? tag.action2FirstPole : tag.action1FirstPole, _tempAems, _tempKeys, _tempGlyphs, results);
		}
		return flag;
	}
	...
	private static bool TryGetControllerElementGlyphsOrText(ControllerElementTag tag, ActionElementMapPair aemPair, Pole firstPole, List<ActionElementMap> tempAems, List<string> tempKeys, List<Sprite> tempGlyphs, List<GlyphOrText> results)
	{
		...
		if (aemPair.a != null && aemPair.b != null)
		{
			...
			object obj = default(object);
			string glyphKey = default(string);
			if (IsGlyphAllowed(tag.type) && ActionElementMap.TryGetCombinedElementIdentifierGlyph((IList<ActionElementMap>)tempAems, ref obj) && ActionElementMap.TryGetCombinedElementIdentifierFinalGlyphKey((IList<ActionElementMap>)tempAems, ref glyphKey))
			{
				item.glyphKey = glyphKey;
				item.sprite = obj as Sprite;
				results.Add(item);
			...
			string text = default(string);
			if (IsTextAllowed(tag.type) && ActionElementMap.TryGetCombinedElementIdentifierName((IList<ActionElementMap>)tempAems, ref text))
			{
				item.name = text;
				results.Add(item);
				return true;
	...
	private static bool TryGetGlyphsOrText(ActionElementMap aem, DisplayType displayType, List<Sprite> glyphs, List<string> keys, List<GlyphOrText> results)
	{
		...
		if (IsGlyphAllowed(displayType) && aem.GetElementIdentifierGlyphs<Sprite>((ICollection<Sprite>)glyphs) > 0)
		{
