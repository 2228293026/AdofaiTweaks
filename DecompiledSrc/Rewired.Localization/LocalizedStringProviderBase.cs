...
public abstract class LocalizedStringProviderBase : MonoBehaviour, ILocalizedStringProvider
{
	...
	public virtual bool prefetch
	{
		...
		{
			_prefetch = value;
			if (base.gameObject.activeInHierarchy && base.enabled && ReInput.isReady && (object)ReInput.localization.localizedStringProvider == this)
			{
	...
	{
		if (ReInput.isReady && (object)ReInput.localization.localizedStringProvider == this)
		{
	...
	protected virtual void TrySetLocalizedStringProvider()
	{
		...
		if (ReInput.isReady)
		{
			...
			ReInput.localization.localizedStringProvider = (ILocalizedStringProvider)(object)this;
