...
public class GlyphProvider : MonoBehaviour, IGlyphProvider
{
	...
	public bool prefetch
	{
		...
		{
			_prefetch = value;
			if (base.isActiveAndEnabled && ReInput.isReady && (object)ReInput.glyphs.glyphProvider == this)
			{
	...
	{
		if (ReInput.isReady && (object)ReInput.glyphs.glyphProvider == this)
		{
	...
	protected virtual void TrySetGlyphProvider()
	{
		...
		if (ReInput.isReady)
		{
			...
			ReInput.glyphs.glyphProvider = (IGlyphProvider)(object)this;
